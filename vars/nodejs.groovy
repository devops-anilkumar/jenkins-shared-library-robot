...
def call() {
    ...
    //    }
       ...
       when { expression { env.TAG_NAME != null} }
           steps {
           sh "curl -f -v -u ${NEXUS_CREDENTIALS_USR}:${NEXUS_CREDENTIALS_PSW} --upload-file ${COMPONENT}-${TAG_NAME}.zip http://${NEXUS_URL}:8081/repository/${COMPONENT}/${COMPONENT}-${TAG_NAME}.zip"
          }
       }
      }
    }
